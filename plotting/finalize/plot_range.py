...
wanted_labels = ['test_range_1', 'test_range_3','test_range_7','test_range_9']
wanted_handles = [handles[labels.index(item)] for item in wanted_labels]
verbose_labels = [r'$s_r=1$', r'$s_r=3$', r'$s_r=7$', r'$s_r=9$']
ax.legend(wanted_handles,verbose_labels, edgecolor='None', facecolor='None')

plt.tight_layout()
# plt.show()
plt.savefig('./pdf/range.pdf', bbox_inches='tight', dpi=300, backend='pdf')
