...
algos_of_domain = {}
algo_domian_paths = {}
task = "with_remote_eval"
paths = [
    "/home/chenxing/experiments/with_remote_eval",
...
def save_by_key(task, key):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('/home/chenxing/experiments/pdf/'+task+'_'+key.replace('/', '_').replace(" ",'_')
+'.pdf', bbox_inches='tight', dpi=300, backend='pdf')
    # plt.clf()
    # print('./plotting/pdf/'+task+'.pdf ','plot finished!')

for key in keys.values():
    save_by_key(task, key)